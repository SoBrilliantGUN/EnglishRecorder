...
export const MULTI_THEMES: MultiTheme[] = [
  { id: 'golden', label: '落日余晖', Component: CardGolden },
...
export const TOPN_THEMES: MultiTheme[] = [
  { id: 'golden', label: '落日余晖', Component: CardGoldenTopN },
...
export const SINGLE_THEMES: SingleTheme[] = [
  { id: 'golden', label: '落日余晖', Component: SingleCardGolden },
